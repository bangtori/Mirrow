...
사용자가 이름을 입력하고 Mirrow를 생성하는 시작 화면입니다.
![랜딩 - 소개페이지](./docs/images/landing1.png)

### 1-2. 본인 단어 선택

57개의 단어 중 자신을 가장 잘 표현한다고 생각하는 단어 6개를 선택합니다.
![본인 단어 선택](./docs/images/landing2.png)

### 1-3. 링크 발급

응답 링크와 결과 링크를 생성하고 친구들에게 공유할 수 있습니다.
![링크 발급](./docs/images/landing3.png)
...
공유받은 사용자가 출제자를 표현하는 단어 6개를 선택합니다.
![응답 페이지](./docs/images/word-select-visitor.png)

### 2-2. Visitor 결과

응답자는 자신의 선택과 출제자의 선택 차이를 비교할 수 있습니다.
![Visitor 결과](./docs/images/visitor-result.png)

## 3. 결과 확인

### 3-1. 조하리 창 결과

수집된 응답을 조하리 창 4개 영역으로 분류하여 시각화합니다.
![내 테스트 결과 페이지](./docs/images/owner-result.png)
