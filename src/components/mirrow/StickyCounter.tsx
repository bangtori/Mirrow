...
export default function StickyCounter({count, onSubmit}: StickyCounterProps) {
    const is_MAX = count >= MAX_COUNT;

    return (
        <div className={`sticky bottom-0 inset-x-0 w-full py-4 px-5 bg-white border-t border-border`}>
