...
export default function LandingClientPage() {
    const { name, handleName, handleSelectedWords, selectedWords, currentStep, createLinks, isCreatingLinks, handleNextStep, links, handleIntroNext, nameError } = useLanding();
    ...
    const stepContent = {
        ...
        3: links ? <CompletePage currentStep={currentStep} name={name} testId={links.testId} resultId={links.resultId} /> : null
    }[currentStep]
